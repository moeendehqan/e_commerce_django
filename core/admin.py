...
class SiteSettingsAdmin(admin.ModelAdmin):
    list_display = ('meta_title', 'meta_description', 'meta_keywords', 'enamad', 'telegram', 'instagram', 'phone', 'email', 'address', 'logo', 'favicon', 'contact_us', 'contact_us_image')
    search_fields = ('meta_title', 'meta_description', 'meta_keywords', 'enamad', 'telegram', 'instagram', 'phone', 'email', 'address', 'logo', 'favicon', 'contact_us', 'contact_us_image')
    list_filter = ('meta_title', 'meta_description', 'meta_keywords', 'enamad', 'telegram', 'instagram', 'phone', 'email', 'address', 'logo', 'favicon', 'contact_us', 'contact_us_image')
    list_per_page = 10
    def changelist_view(self, request, extra_context=None):
...
class TelegramSettingAdmin(SingletonAdmin):
    fieldsets = (
        (None, {
            'fields': ('token', 'chat_id', 'notification_new_order', 'notification_new_contact'),
            'description': (
                '<p class="text-blue-600 font-bold">راهنما:</p>'
                '<p>در این بخش می‌توانید تنظیمات تلگرام را ویرایش کنید.</p>'
            ),
        }),
    )
    def get_queryset(self, request):
