    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offers', models.BooleanField(default=True, verbose_name='نمایش پیشنهادات')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('umami_id', models.CharField(blank=True, help_text='شناسه ردیابی Umami رو اینجا وارد کنید (مثل 1234567890)', max_length=20, null=True, verbose_name='شناسه ردیابی Umami')),
            ],
            options={
